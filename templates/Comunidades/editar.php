<div class="container-xl">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Editar Comunidad: <?= h($comunidad->nombre) ?></h3>
        </div>
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <?php if (!empty($comunidad->foto)): ?>
                            <div class="mt-2">
                                <?= $this->Html->image($comunidad->foto, ['class' => 'img-thumbnail', 'style' => 'max-width: 150px']) ?>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="mb-3">
                        ...
                        <?php if (!empty($comunidad->banner)): ?>
                            <div class="mt-2">
                                <?= $this->Html->image($comunidad->banner, ['class' => 'img-thumbnail', 'style' => 'max-width: 150px']) ?>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
